...
{
    /// <summary>
    /// Clasa TrainingDataset reprezintă un set de date pentru antrenament, inclusiv instanțe și clasa corespunzătoare.
    /// </summary>
    public class TrainingDataset
    {
        ...
        public TrainingDataset(int [] clasa, double[][] instances)
        {
